...
class TFAGATEWAY_V2 extends IPSModule
{
    ...
    public function HTTP_Response_OK(string $ClientIP, int $ClientPort)
    {
        ...
        $dataresponse = [0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x17, 0x61, 0xd4, 0x80, 0x00, 0x00, 0x00, 0x01];
...
. $this->name . '_Send_Rest_to_Gateway(' . $this->InstanceID . ',"' . $mac . '","' . $ip . '");';
    ...
    private function Send_UDP_PACKET($cmd, $mac, $ip)
    {
        ...
        $data = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a];
