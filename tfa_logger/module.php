...
class TFALOGGER_V2 extends IPSModule
{
    ...
    public function GetConfigurationForm()
    {
        ...
        $form = [
            'elements' => [
                ...
                ['type' => 'CheckBox',       'name' => 'var_active',       'caption' => 'recording active'],
                ['type' => 'NumberSpinner',  'name' => 'var_max',          'caption' => 'keep entries', 'minimum' => 1, 'maximum' => 5000],
                ['type' => 'CheckBox',       'name' => 'var_only_unknown', 'caption' => 'only unknown sensors'],
                ['type' => 'ValidationTextBox', 'name' => 'var_filter_id', 'caption' => 'only this device id (optional)'],
                ['type' => 'CheckBox',       'name' => 'var_to_syslog',    'caption' => 'also write to the message log'],
                ...
                [
                    ...
                    'delete'   => false,
                    'columns'  => [
                        ['caption' => 'time',      'name' => 'time',     'width' => '160px'],
                        ['caption' => 'device id', 'name' => 'deviceid', 'width' => '150px'],
                        ['caption' => 'type',      'name' => 'typ',      'width' => '60px'],
                        ['caption' => 'known',     'name' => 'known',    'width' => '110px'],
                        ['caption' => 'header',    'name' => 'header',   'width' => '80px'],
                        ['caption' => 'length',    'name' => 'length',   'width' => '80px'],
                        ['caption' => 'crc',       'name' => 'crc',      'width' => '70px'],
                        ['caption' => 'packet',    'name' => 'frame',    'width' => 'auto'],
                    ],
                    'values'   => $log,
                ],
            ],
            ...
            'actions' => [
                [
                    ...
                    'popup'   => [
                        'caption' => 'copy as text',
                        'items'   => [
                            ['type' => 'Button', 'caption' => 'create', 'onClick' => $this->name . '_MakeText($id);'],
                            ['type' => 'ValidationTextBox', 'name' => 'logtext', 'caption' => 'recording', 'multiline' => true],
                        ],
                    ],
                ],
                ['type' => 'Button', 'caption' => 'clear recording', 'onClick' => $this->name . '_ClearLog($id);'],
