...
class TFACONFIGURATOR_V2 extends IPSModule
{
        ...
        $form = [
            'elements' => [
                ...
                [
                    ...
                    'add'        => false,
                    'delete'     => false,
                    'sort'       => ['column' => 'deviceid', 'direction' => 'ascending'],
                    'columns'    => [
                        ['caption' => 'device id', 'name' => 'deviceid', 'width' => '160px'],
                        ['caption' => 'type',      'name' => 'typ',      'width' => '60px'],
                        ['caption' => 'sensor',    'name' => 'name',     'width' => 'auto'],
                        ['caption' => 'article',   'name' => 'article',  'width' => '140px'],
                        ['caption' => 'state',     'name' => 'state',    'width' => '180px'],
                        ['caption' => 'packets',   'name' => 'count',    'width' => '80px'],
                    ],
                    'values'     => $rows,
                ],
            ],
    ...
    private function PickOptions($rows)
    {
        ...
        if (count($options) == 0) {
            $options[] = ['caption' => $this->Translate('no unknown sensor seen'), 'value' => ''];
        }
